    ...
    <main class="contents">
        <div class="row">
            <div class="content-wrapper">
                ...
                <a href="login.php" class="btn satu">Login Admin</a>
                <a href="loginuser.php" class="btn dua">Login User</a>
            </div>

            <div class="content-wrapper">
                <img src="images/buku.png" alt="" srcset="" height="300px" width="300px">
            </div>
